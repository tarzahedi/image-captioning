...
if selected == "Home":
    ...
    with col1:
        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2ew7u6dEGWAZWQJcjZ5yofPZuWdwuKJb2HRch22JR8yyIlSLDW29nHzWMFuw2pG01X-A&usqp=CAU")
        st.write("Caption: dogs on the beach")
    with col2:

        st.image("https://media-cldnry.s-nbcnews.com/image/upload/newscms/2017_03/1868126/ss-170117-men-who-walked-moon-duke-mn-11.jpg")
        st.write("Caption: astronaut on the moon during space mission")
    with col3:

        st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_mVdZJqudtSUtFyZfoUUZj74P_Y8Lv3GKlQ&usqp=CAU")
        st.write("Caption: football player celebrates after scoring a goal during the final against football team")
...
#ASK YOUR IMAGE
            st.title(":camera_with_flash: :grey_question: Now Ask It a Question:")
